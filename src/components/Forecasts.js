...
function Forecasts(props) {
    ...
    return (
        <>
            <Button variant="success" onClick={() => ReqForecastsDays()} className="batn">Узнать погоду на 5 дней</Button>
            <Button variant="success" onClick={() => OneDayForecasts()}>Узнать погоду сейчас</Button>
